function [W_all, stat] = tvglearn_fusedlasso_real(Z, alpha, beta, eta, params)
...
if not(isfield(params, 'step_size')),   params.step_size = .99;      end     % from (0, 1), in otehr words, 0<step_size<1
