function [W, stat, primal_gap_iter] = gsp_learn_graph_log_degrees_(Z, a, b, alpha, beta, stepsize, max_iter, epsilon, W_opt, params)
...
if not(isfield(params, 'tol')),         params.tol = epsilon;      end
