function [W, fval_admm, primal_gap_iter] = gl_admm_runtime(X, alpha, beta, t, tau1, tau2, max_iter, epsilon, W_opt)
...
for k = 1 : max_iter
    ...
    fval_iter(k) = 2*(z')*w - alpha*sum(log(d)) + beta*(w')*w; % commented when comparing runtime
